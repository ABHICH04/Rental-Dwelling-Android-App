...
public class AddHouse extends AppCompatActivity {
    ...
    EditText et_houseId, et_houseLocation, et_noOfRoom, et_rentPerRoom, et_houseDescription,et_ownerContact;
    Button btn_addHouse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_addHouse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ownerContact = et_ownerContact.getText().toString();
                String image = imageString;


                createFood(houseId, houseLocation, noOfRoom, rentPerRoom, houseDescription,ownerContact, image);
            }
        });
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void createFood(String houseId, String houseLocation, String noOfRoom, String rentPerRoom, String houseDescription,String ownerContact, String image) {
